...
save_directory = '/Users/stephenholtz/panels_experiments/position_functions/unilat_windowed_prog_reg_osc_grats_w_flicker';
...
for spat_freq = spatial_freqs
    for temp_freq = temp_freqs
        for direction = [1 -1]
            ...
            [func,pos_func_samp_freq] = make_determine_best_samp_rate_simple_tri_wave_pos_funcs(spat_freq,temp_freq,direction,dummy_frame_flag);
