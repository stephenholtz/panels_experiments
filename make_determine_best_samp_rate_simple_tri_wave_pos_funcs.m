function [function_vector,min_pos_func_sample_rate] = make_determine_best_samp_rate_simple_tri_wave_pos_funcs(spatial_freq,temporal_freq,direction,dummy_frame_flag)
...
for step = [1:spatial_freq (spatial_freq-1):-1:2 ]
